...
- :meth:`.VibrationsData.todict` no longer throws an error when
  the length of :attr:`.VibrationsData._indices` is not 1 but
  differs from the length of :attr:`.VibrationsData._atoms`
