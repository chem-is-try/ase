...
--------
 ...
 - Added divergence check for infinite direction norm in :meth:`ase.mep.dimer.MinModeTranslate.step` (:mr:`4041`)
 - Prevent step in `ase.mep.dimer.MinModeTranslate.step` from becoming NaN (:mr:`4041`)
